...
#set_property -dict { PACKAGE_PIN E35   IOSTANDARD LVDS     } [get_ports { DDR_CLK_N }]; #IO_L13N_T2_MRCC_35 Sch=ddr3_sysclk_n
#set_property -dict { PACKAGE_PIN E34   IOSTANDARD LVDS     } [get_ports { DDR_CLK_P }]; #IO_L13P_T2_MRCC_35 Sch=ddr3_sysclk_p
#create_clock -add -name ddr_clk_pin -period 4.285715 -waveform {0 2.1428575} [get_ports {DDR_CLK_P}];
...
set_property -dict {PACKAGE_PIN BA19 IOSTANDARD LVCMOS15} [get_ports UART_RXD_OUT]
set_property -dict {PACKAGE_PIN AY19 IOSTANDARD LVCMOS15} [get_ports UART_TXD_IN]
...
##PCIe Control
set_property -dict {PACKAGE_PIN AY35 IOSTANDARD LVCMOS18} [get_ports PERSTN]
...
set_property -dict {PACKAGE_PIN Y4} [get_ports {PCIE_RX_P[0]}]
set_property -dict {PACKAGE_PIN Y3} [get_ports {PCIE_RX_N[0]}]
set_property -dict {PACKAGE_PIN W2} [get_ports {PCIE_TX_P[0]}]
set_property LOC GTHE2_CHANNEL_X1Y23 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[0].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN W1} [get_ports {PCIE_TX_N[0]}]
set_property -dict {PACKAGE_PIN AA6} [get_ports {PCIE_RX_P[1]}]
set_property -dict {PACKAGE_PIN AA5} [get_ports {PCIE_RX_N[1]}]
set_property -dict {PACKAGE_PIN AA2} [get_ports {PCIE_TX_P[1]}]
set_property LOC GTHE2_CHANNEL_X1Y22 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[1].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN AA1} [get_ports {PCIE_TX_N[1]}]
set_property -dict {PACKAGE_PIN AB4} [get_ports {PCIE_RX_P[2]}]
set_property -dict {PACKAGE_PIN AB3} [get_ports {PCIE_RX_N[2]}]
set_property -dict {PACKAGE_PIN AC2} [get_ports {PCIE_TX_P[2]}]
set_property LOC GTHE2_CHANNEL_X1Y21 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[2].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN AC1} [get_ports {PCIE_TX_N[2]}]
set_property -dict {PACKAGE_PIN AC6} [get_ports {PCIE_RX_P[3]}]
set_property -dict {PACKAGE_PIN AC5} [get_ports {PCIE_RX_N[3]}]
set_property -dict {PACKAGE_PIN AE2} [get_ports {PCIE_TX_P[3]}]
set_property LOC GTHE2_CHANNEL_X1Y20 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[3].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN AE1} [get_ports {PCIE_TX_N[3]}]
set_property -dict {PACKAGE_PIN AD4} [get_ports {PCIE_RX_P[4]}]
set_property -dict {PACKAGE_PIN AD3} [get_ports {PCIE_RX_N[4]}]
set_property -dict {PACKAGE_PIN AG2} [get_ports {PCIE_TX_P[4]}]
set_property LOC GTHE2_CHANNEL_X1Y19 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[4].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN AG1} [get_ports {PCIE_TX_N[4]}]
set_property -dict {PACKAGE_PIN AE6} [get_ports {PCIE_RX_P[5]}]
set_property -dict {PACKAGE_PIN AE5} [get_ports {PCIE_RX_N[5]}]
set_property -dict {PACKAGE_PIN AH4} [get_ports {PCIE_TX_P[5]}]
set_property LOC GTHE2_CHANNEL_X1Y18 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[5].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN AH3} [get_ports {PCIE_TX_N[5]}]
set_property -dict {PACKAGE_PIN AF4} [get_ports {PCIE_RX_P[6]}]
set_property -dict {PACKAGE_PIN AF3} [get_ports {PCIE_RX_N[6]}]
set_property -dict {PACKAGE_PIN AJ2} [get_ports {PCIE_TX_P[6]}]
set_property LOC GTHE2_CHANNEL_X1Y17 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[6].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN AJ1} [get_ports {PCIE_TX_N[6]}]
set_property -dict {PACKAGE_PIN AG6} [get_ports {PCIE_RX_P[7]}]
set_property -dict {PACKAGE_PIN AG5} [get_ports {PCIE_RX_N[7]}]
set_property -dict {PACKAGE_PIN AK4} [get_ports {PCIE_TX_P[7]}]
set_property LOC GTHE2_CHANNEL_X1Y16 [get_cells {axi_pcie3_inst/inst/pcie3_ip_i/inst/gt_top_i/pipe_wrapper_i/pipe_lane[7].gt_wrapper_i/gth_channel.gthe2_channel_i}]
set_property -dict {PACKAGE_PIN AK3} [get_ports {PCIE_TX_N[7]}]
...
##SFP Transceivers
#set_property -dict { PACKAGE_PIN A6 } [get_ports { ETH1_TX_P }];
...
set_property LOC GTHE2_CHANNEL_X1Y39 [get_cells -hier -filter name=~*ethernet_share*gthe2_i]
...
##SFP ETH1 Misc.
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS15} [get_ports ETH1_TX_LED]
set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS15} [get_ports ETH1_RX_LED]
