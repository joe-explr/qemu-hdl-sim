...
set_property range 16E                        [ipx::get_address_spaces M_AXI    -of_objects [ipx::current_core]]
...
set_property display_name               S_AXI                   [ipx::get_memory_maps       S_AXI     -of_objects [ipx::current_core]]
ipx::add_address_block                  BAR0                   [ipx::get_memory_maps        S_AXI     -of_objects [ipx::current_core]]
set_property range 16E [ipx::get_address_blocks BAR0 -of_objects [ipx::get_memory_maps      S_AXI     -of_objects [ipx::current_core]]]
...
ipx::remove_all_user_parameter [ipx::current_core]
ipx::infer_user_parameters [ipx::current_core]

ipgui::remove_page -component [ipx::current_core] [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]

ipgui::add_page -name {AXI Parameters} -component [ipx::current_core] -display_name {AXI Parameters}

ipgui::add_param -name {TAGW} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "AXI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {ADRW} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "AXI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {DATW} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "AXI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {SIZE} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "AXI Parameters" -component [ipx::current_core] ]


ipgui::add_page -name {PCI Parameters} -component [ipx::current_core] -display_name {PCI Parameters}
ipgui::add_param -name {VENDOR_ID} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {DEVICE_ID} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {IS64BIT} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {PREFETCH} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {MSIX_VEC_NUM} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {MSIX_TABLE_BAR} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {MSIX_TABLE_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {MSIX_PBA_BAR} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {MSIX_PBA_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "PCI Parameters" -component [ipx::current_core] ]

ipgui::add_page -name {BAR Parameters} -component [ipx::current_core] -display_name {BAR Parameters}
ipgui::add_param -name {BAR0} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR0_SIZE} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR0_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR1} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR1_SIZE} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR1_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR2} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR2_SIZE} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR2_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR3} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR3_SIZE} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR3_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR4} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR4_SIZE} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR4_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR5} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR5_SIZE} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]
ipgui::add_param -name {BAR5_OFFSET} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "BAR Parameters" -component [ipx::current_core] ]

ipgui::add_page -name {Misc} -component [ipx::current_core] -display_name {Misc}
ipgui::add_param -name {DTMP} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "Misc" -component [ipx::current_core] ]
ipgui::add_param -name {CLKOFREQ} -component [ipx::current_core] -parent [ipgui::get_pagespec -name "Misc" -component [ipx::current_core] ]

set_property enablement_value false [ipx::get_user_parameters STBW -of_objects [ipx::current_core]]
set_property value_tcl_expr {expr $DATW/8} [ipx::get_user_parameters STBW -of_objects [ipx::current_core]]

set_property enablement_value false [ipx::get_user_parameters NSTB -of_objects [ipx::current_core]]
set_property value_tcl_expr {expr ($DTMP/($DATW/8))} [ipx::get_user_parameters NSTB -of_objects [ipx::current_core]]
